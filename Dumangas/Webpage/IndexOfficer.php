<div class="col-officer-jewels">
    <h2>Officers of High Twelve Masonic Lodge No. 82</h2>
    ...
    <div class="officer">
        ...
        <div class="officers-card">
            <img src="" alt="Officer Image" />
            <div class="text-overlay">
                <h2>Bro. Patroclus K. Ferreras</h2>
        ...
        <div class="officers-card">
            <img src="" alt="Officer Image" />
            <div class="text-overlay">
                <h2>Bro. Leonides T. Balisi</h2>
                <h3>Custodian of Works</h3>
            </div>
        </div>
        <div class="officers-card">
            <img src="" alt="Officer Image" />
            <div class="text-overlay">
                <h2>Bro. Jeffrey H. Calitis</h2>
